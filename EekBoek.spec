...
Name: %modname%{modsuffix}
Version: %modversion
Release: 1
Source: http://www.eekboek.nl/dl/%{modname}-%{version}.tar.gz
BuildArch: noarch
URL: http://www.eekboek.nl
BuildRoot: %{_tmppath}/rpm-buildroot-%{modname}-%{version}-%{release}
Prefix: %{_prefix}
...
%if %{gui}
%package gui
Summary: GUI enhancements for %{modname}.
Group: Applications/Productivity
AutoReqProv: 0
