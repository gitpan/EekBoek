...
Obsoletes: %{name}-core = 2.00.00

%description
%{name} contains all necessary files for the EekBoek API and the
command line version of the program. This includes support for the
SQLite database.

For GUI support, install %{name}-gui.

For PostgreSQL support, also install %{name}-db-postgresql.
